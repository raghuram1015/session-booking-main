                        ...
                        ${
                          session.meetingUrl
                            ? `<div class="detail-item">
                                ...
                                <span class="detail-value"><a href="${session.meetingUrl}" target="_blank">${session.meetingUrl}</a></span>
                            </div>`
                            : ""
                        }
                    </div>
        ...
        <div class="session-meta">
            ...
            ${
              session.meetingUrl
                ? `<div class="meta-item">
                    <span class="meta-icon">🔗</span>
                    <span><a href="${session.meetingUrl}" target="_blank">Meeting URL</a></span>
                  </div>`
                : ""
            }
        </div>
