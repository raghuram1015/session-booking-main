...
// Wait for auth to be ready before running page-specific logic
...
if (createSessionForm) {
  ...
  createSessionForm.addEventListener("submit", async (e) => {
    ...
    const maxBookings = Number.parseInt(
      document.getElementById("maxBookings").value
    );
...
function createSessionCard(sessionId, session) {
  ...
  card.innerHTML = `
        ...
        <a href="session-detail.html?id=${sessionId}" class="btn-primary btn-full ${
    isFull ? "disabled" : ""
  }">
                ...
                <div class="session-detail-content">
                    ...
                    <div class="detail-grid">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value">${spotsLeft} / ${
      session.maxBookings
    }</span>
                        </div>
                    </div>
...
function createMySessionCard(sessionId, session) {
  ...
  const statusClass =
    session.status === "active" ? "status-active" : "status-cancelled";
...
window.editSession = async (sessionId) => {
  try {
    ...
    document.getElementById("edit-meetingLink").value = session.meetingLink || "";
...
if (editSessionForm) {
  editSessionForm.addEventListener("submit", async (e) => {
    ...
    const maxBookings = Number.parseInt(
      document.getElementById("edit-maxBookings").value
    );
    const meetingLink = document.getElementById("edit-meetingLink").value;
