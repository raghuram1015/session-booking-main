...
// Wait for authentication to be ready before loading the dashboard
onAuthStateChanged(auth, (user) => {
  if (user) {
    // User is signed in, now we can safely load the dashboard data.
    loadDashboard();
  } else {
    // User is signed out. The redirect logic in auth.js will handle this.
    console.log("No user is signed in on dashboard page.");
  }
});
